...
/// label so neither is squeezed. Without [onTap] it is read-only and has no
/// chevron. Numbers use tabular figures.
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoListTile(
      ...
      title: large
          ...
          : Row(
              children: [
                // Labels are short ("Warm Rent"); the value takes the rest.
